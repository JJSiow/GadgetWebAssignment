...
{
    $conditions = ["o.order_status = 'delivered'"];
    $params = [];
...
<div class="container">
    ...
    <div class="status-buttons">
        ...
        <button data-get="admin_delivered.php" class="active">Delivered</button>
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <?php if (empty($processedOrders)): ?>
                    <tr>
                        <td colspan="7" class="no-records">No delivered orders found...</td>
                    </tr>
                <?php else: ?>

    ...
    <body>
        <div class="reset-ps-container">
            <div class="reset-ps-form">
                ...
                <h1>Member<span style="color: #007bff;"> Profile</span></h1>
                    ...
                    <section>
                        ...
                        <button type="button" class="btn-delete-acc" data-post="delete_member_account.php?member_id=<?= $member_id ?>" data-confirm="Are you sure you want to delete your account permanently?">Delete Account</button>
                    </section>
                </form>
            </div>
        </div>
